...
class Vc_Frontend_Editor {
	...
	public function loadIFrameJsCss() {
		...
		wp_enqueue_style( 'line_awesome', vc_asset_url( 'fonts/line-awesome/css/line-awesome.min.css' ), WPB_VC_VERSION );
	...
	public function registerCss() {
		...
		wp_register_style( 'line_awesome', vc_asset_url( 'fonts/line-awesome/css/line-awesome.min.css' ), WPB_VC_VERSION );
