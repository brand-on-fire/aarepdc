...
$labels = array(
	'name'                  => esc_html_x( 'Product Layouts', 'Post Type General Name', 'landinghub-core' ),
	'singular_name'         => esc_html_x( 'Product Layout', 'Post Type Singular Name', 'landinghub-core' ),
	'menu_name'             => esc_html__( 'Product Layouts', 'landinghub-core' ),
	'name_admin_bar'        => esc_html__( 'Product Layouts', 'landinghub-core' ),
