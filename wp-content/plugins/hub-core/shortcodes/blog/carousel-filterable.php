...
$GLOBALS['wp_query'] = new WP_Query( $this->build_query() );		
	echo '<div class="carousel-items row" data-lqd-flickity=\'{ "filters": "#' . $filter_id . '", "prevNextButtons": true, "wrapAround": false, "navArrow": 1, "fullwidthSide": true, "navOffsets": { "nav": {"left": "-10px", "top": "200px"} } }\'>';
