...
<header class="main-header lqd-main-header-default">
	...
	<div class="lqd-head-sec-wrap pos-rel">
		...
		<div class="lqd-head-sec container-fluid d-flex align-items-center ps-3 pe-3">
				...
				<div class="lqd-head-col elementor-widget-wrap col d-flex">

					<div class="header-module elementor-element module-logo pt-5 pb-5" style="width: auto;">
				...
				<div class="lqd-head-col elementor-widget-wrap col d-flex justify-content-end flex-grow-1">

					<div class="header-module elementor-element pos-stc pt-0 pb-0" style="width: auto;">
						...
						<div class="header-module elementor-element" style="width: auto;">
